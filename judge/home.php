      ...
      <div class="navbar-inner">
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <a class="brand" href="enent/index.php"><img src="uploads/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">Inter College Meet</font></a> 
...
<header class="jumbotron subhead" id="overview">
  ...
  <p class="lead">Inter College Meet</p>
  </div>
</header>
